<template>
    <div>
        ...
        <div class="container1">
            ...
            />
            <div>
                <h2>Cena: {{cena3}} Kč / den</h2>
                <p>Elektrické koloběžky byly vyvinuty
                     ve spolupráci s techniky a specialisty společnosti Koloběžky.
                      Mají zvýšenou ODOLNOST a SPOLEHLIVOST, VYLEPŠENÉ BRZDY a PEVNĚJŠÍ KOLA.<br>
                       Můžou dosahovat rychlosti až 20 km/h.</p>
...
export default {
  ...
  data() {
    return {
      ...
      loop: true,
      dataSource: [
        "https://thumb.tildacdn.com/tild3032-3166-4333-a231-666563616630/-/format/webp/f9c495d3221b4b33479e.png",
        "https://thumb.tildacdn.com/tild3861-3565-4532-a431-633137353937/-/format/webp/1-2jpg.png",
        "https://www.cdiscount.com/pdt2/9/6/2/1/1200x1200/ico4895160633962/rw/trottinette-electrique-tracer-iconbit-8-250w-noir.jpg"
      ],
      min: new Date(),
      listofavailable: [],
      numberofavailable: 0,
...
created() {
    ...
    RezervaceService.getNameByType(3)
 ...
 methods: {
   ...
   async GetNumberOfAvailable() 
        {
         await RezervaceService.getAvailable(this.datefrom.getDate(),this.datefrom.getMonth()+1,this.datefrom.getFullYear(),this.dateto.getDate(),this.dateto.getMonth()+1,this.dateto.getFullYear(),3)
        ...
        Pridatdokosiku() 
        {
          ...
          orders.push({idkolobezka:this.listofavailable[0], typ: 3, datumzapujceni:datumod, datumvraceni:datumdo, nazev: this.jmenokolobezky, cena: (this.cena3*days)});
